...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_catalogue&task=form.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_catalogue&view=forms'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="table table-striped" id="articleList">
			<thead>
				<tr>
					...
					<th>
						<?php echo JHtml::_('grid.sort', 'COM_CATALOGUE_HEADING_NAME', 'f.form_name', $listDirn, $listOrder); ?>
					</th>
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->catid?>">
					...
					<td class="center">
						<?php echo JHtml::_('jgrid.published', $item->published, $i, 'forms.', true, 'cb', $item->publish_up, $item->publish_down); ?>
					</td>
					<td class="nowrap has-context">
						<div class="pull-left">
							<?php if ($item->checked_out) : ?>
								<?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'form.', $canCheckin); ?>
							<?php endif; ?>
							<?php if ($canEdit) : ?>
								<a href="<?php echo JRoute::_('index.php?option=com_catalogue&task=form.edit&id='.(int) $item->id); ?>">
									<?php echo $this->escape($item->form_name); ?></a>
							<?php else : ?>
						...
						<div class="pull-left">
							<?php
								...
								if ($archived) :
									JHtml::_('dropdown.unarchive', 'cb' . $i, 'forms.');
								else :
									JHtml::_('dropdown.archive', 'cb' . $i, 'forms.');
								endif;
