            ...
            <div class="span4">
                ...
                <div class="item-price-wrapper">
                    <p>
                        ...
                        <span class="item-price"><?php if($category->min_price && $category->max_price){ echo 'от '.number_format($category->min_price, 0, '.', ' ').' до '.number_format($category->max_price, 0, '.', ' ').' '.$params->get('catalogue_currency'); } else { echo "по запросу"; } ?></span>
                    </p>
                </div>
            </div>
    <?php endforeach; ?>
