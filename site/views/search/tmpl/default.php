...
<div class="catalogue-items" id="catalogue">
    ...
    <?php if (count($this->items)): ?>
        <p class="ben-desc">
            Для заказа, пожалуйста, проставьте требуемое количество изделий около каждого необходимого наименования и
            нажмите "В корзину".</br>
                ...
                <tr>
                    ...
                    <td>
                        <div class="item-count">
                            <input value="<?php echo $gc = CatalogueHelper::getCount($item->id); ?>"
                                   class="input-count"/>
                    ...
                    <td>
                        ...
                        <a href="#" id="b<?php echo $item->id; ?>" data-id="<?php echo $item->id; ?>" class="addToCart">В
                            корзину</a></td>
                    <?php else : ?>
