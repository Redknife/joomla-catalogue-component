            ...
            <div class="span4">
                ...
                <div class="item-price-wrapper">
                    <p>
                        ...
                        <span class="item-price"><?php if ($item->min_price && $item->max_price) {
                                echo 'от ' . number_format($item->min_price, 0, '.', ' ') . ' до ' . number_format($item->max_price, 0, '.', ' ') . ' ' . $params->get('catalogue_currency');
                            } else {
                                echo "по запросу";
                            } ?></span>
                    </p>
