    ...
    <?php foreach ($this->items as $item) : ?>
        <li class="one-item span3 white-box">
            ...
            <a href="<?php echo $ilink; ?>" class="item-link">
                <img src="<?php $imgpath = CatalogueHelper::createThumb($item->id, $item->item_image, 218, 203);
                if ($imgpath) {
                    echo $imgpath;
                } else {
                    echo '/templates/blank_j3/img/imgholder.jpg';
                } ?>"/>
            ...
            <div class="info">
                ...
                <?php if (!CatalogueHelper::inCart($item->id)) : ?>
                    <a href="index.php?option=com_catalogue&task=order&orderid=<?php echo $item->id; ?>&Itemid=114&backuri=<?php echo base64_encode(JURI::current()); ?>"
