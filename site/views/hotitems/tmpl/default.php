...
// $path = $app->getPathway();
// $path->addItem('Популярные товары');
?>
    ...
    <div class="row">
        <div class="left-menu span3">
            ...
            <ul class="unstyled hot-new-items">
                <li>&mdash;<a
                        href="<?php echo JRoute::_('index.php?option=com_catalogue&view=hotitems&Itemid=111'); ?>">Популярные
                        товары</a></li>
                <li>&mdash;<a
                        href="<?php echo JRoute::_('index.php?option=com_catalogue&view=hotitems&Itemid=112'); ?>">Новинки</a>
                </li>
            </ul>
        </div>
