...
$sectionid = JRequest::getVar('sid', 0, '', 'int');
$categoryid = JRequest::getVar('cid', 0, '', 'int');
?>
<h2>Каталог</h2>
<ul class="unstyled">
<?php foreach ($this->items as $item) : ?>
        <li class="one-item span3 white-box">
        <?php $ilink = JRoute::_( 'index.php?option=com_catalogue&view=item&sid='.$sectionid.'&cid='.$categoryid.'&id='.$item->id.'&Itemid=110' ); ?>
