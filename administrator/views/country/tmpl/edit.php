...
<form
    action="<?php echo JRoute::_('index.php?option=com_catalogue&view=country&layout=edit&id=' . (int)$this->item->id); ?>"
        ...
        <fieldset>
            <ul class="nav nav-tabs">
                <li class="active"><a href="#details"
                                      data-toggle="tab"><?php echo JText::_('COM_CATALOGUE_COUNTRY_DETAILS'); ?></a>
                </li>
            </ul>
